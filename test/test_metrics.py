...
# class TestMetrics:
  ...
  def test_neg_acc(self):
    ...
    target = torch.tensor([
      ...
      [SOS, MARY, HEAR, ALICE, EOS,   PAD]] # No NEG
    )
  ...
  def test_linearA(self):
    ...
    prediction = torch.tensor([
      ...
      [SOS, SEE, L_PAREN, MARY, COMMA, MARY, R_PAREN, AND, NEAR, L_PAREN, ALICE, COMMA, MARY, R_PAREN, EOS] # Linear A error
      ]
    )
    prediction = F.one_hot(prediction).permute(0,2,1)
  ...
  def test_linearB(self):
    ...
    prediction = torch.tensor([
      [SOS, SEE, L_PAREN, ALICE, COMMA, ALICE, R_PAREN, EOS, PAD, PAD, PAD, PAD, PAD, PAD, PAD], # Doesn't count
      [SOS, SEE, L_PAREN, ALICE, COMMA, ALICE, R_PAREN, AND, NEAR, L_PAREN, ALICE, COMMA, MARY, R_PAREN, EOS], # Same as target
      [SOS, SEE, L_PAREN, ALICE, COMMA, MARY, R_PAREN, AND, NEAR, L_PAREN, ALICE, COMMA, MARY, R_PAREN, EOS] # Linear B error
      ]
    )
    prediction = F.one_hot(prediction).permute(0,2,1)
